...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'posts_post', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'posts_post_created_by', null=True, to=orm['accounts.User'])),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'posts_post_modified_by', null=True, to=orm['accounts.User'])),
            ('publishing_status', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('byline', self.gf('django.db.models.fields.TextField')(blank=True)),
    ...
    models = {
        u'accounts.user': {
            ...
            'github_username': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True', 'blank': 'True'}),
        ...
        u'posts.post': {
            ...
            'byline': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'posts_post_created_by'", 'null': 'True', 'to': u"orm['accounts.User']"}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            ...
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'posts_post_modified_by'", 'null': 'True', 'to': u"orm['accounts.User']"}),
            'publishing_status': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
